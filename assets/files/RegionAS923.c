...
static bool VerifyRfFreq( uint32_t freq, uint8_t *band )
{
    ...
    if( ( freq >= 921000000 ) && ( freq < 921400000 ) )
    {
        *band = 2;
    }
    else if( ( freq > 921200000 ) && ( freq < 921600000 ) )
    {
        *band = 0;
    }
    else if( ( freq > 921400000 ) && ( freq < 921800000 ) )
    {
        *band = 1;
    }
    else if( ( freq > 921600000 ) && ( freq < 922000000 ) )
    {
        *band = 3;
    }
    else if( ( freq > 921800000 ) && ( freq < 922200000 ) )
    {
        *band = 4;
    }
    else if( ( freq > 922000000 ) && ( freq < 922400000 ) )
    {
        *band = 5;
    }
    else if( ( freq > 922200000 ) && ( freq < 922600000 ) )
    {
        *band = 6;
    }
    else if( ( freq > 922400000 ) && ( freq <= 922800000 ) )
    {
        *band = 7;
    }
    else
...
PhyParam_t RegionAS923GetPhyParam( GetPhyParams_t* getPhy )
{
    ...
    switch( getPhy->Attribute )
    {
        ...
        {
            phyParam.Value = MaxPayloadOfDatarateAS923[getPhy->Datarate];
            break;
        }
        case PHY_MAX_PAYLOAD_REPEATER:
        {
            phyParam.Value = MaxPayloadOfDatarateRepeaterAS923[getPhy->Datarate];
            break;
        }
        case PHY_DUTY_CYCLE:
        {
...
void RegionAS923InitDefaults( InitDefaultsParams_t* params )
{
    ...
    switch( params->Type )
    {
        case INIT_TYPE_INIT:
        {
            ...
            NvmCtx.Channels[2] = ( ChannelParams_t ) AS923_LC3;
...
bool RegionAS923RxConfig( RxConfigParams_t* rxConfig, int8_t* datarate )
{
    ...
    {
        maxPayload = MaxPayloadOfDatarateRepeaterAS923[dr];
    }
    else
    {
        maxPayload = MaxPayloadOfDatarateAS923[dr];
    }
